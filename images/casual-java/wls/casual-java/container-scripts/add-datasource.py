...
dsdrivername = os.environ.get('DATASOURCE_DRIVER_NAME','org.apache.derby.jdbc.EmbeddedXADataSource')
dsurl = os.environ.get('DATASOURCE_URL','jdbc:derby:memory:sampleDB')
